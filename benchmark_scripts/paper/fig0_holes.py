...
def genPolygon_with_hole(INPUT_BBOX, num_points=None, area_percentage=None, hole_size=None):
    ...
    if hole_size is None:
        hole_size = 0.3 # random.uniform(0.2, 0.6)  # Size of hole relative to outer polygon
    ...
    for i in range(num_points):
        ...
        radius_factor = random.uniform(0.8, 1.0) #random.uniform(0.85, 1.15)
    ...
    for i in range(hole_num_points):
        ...
        radius_factor = random.uniform(0.75, 1.15) * hole_size
